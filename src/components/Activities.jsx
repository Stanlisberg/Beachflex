...
function Activities() {
  const { remove } = useContext(BeachflexContext);
//   console.log(remove);
  return (
    <div className="max-w-[1140px] m-auto w-full md:flex mt-[-75px]">
      <div className="relative p-4">
        {!remove ? (
          <h3 className="absolute z-10 top-[50%] left-[50%] translate-x-[-55%] translate-y-[-55%] text-white text-2xl font-bold opacity-5">
            Resorts
          </h3>
        ) : (
          <h3 className="absolute z-10 top-[50%] left-[50%] translate-x-[-55%] translate-y-[-55%] text-white text-2xl font-bold">
            Resorts
          </h3>
        )}
        <img
